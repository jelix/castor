...
- CastorCore: new protected methods `_callMeta` and `_callContent` allowing to redefine how content of generated templates should be called.
- Fix url generated by the gravatar plugin
- Fix the count_characters modifier on UTF-8 strings
